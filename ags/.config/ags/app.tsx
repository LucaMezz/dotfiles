...
const MATUGEN_DIR = `${GLib.get_user_config_dir()}/ags`;
  ...
  requestHandler(argv, res) {
    ...
    if (argv[0] === "RightSidebar") {
      ...
      if (monitors.length > 0) {
        const leftmost = [...monitors].sort(
          (a, b) => a.get_geometry().x - b.get_geometry().x,
        )[0];
        app.toggle_window(`RightSidebar-${leftmost.connector}`);
        return res("ok");
      }
